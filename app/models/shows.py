...
class ShowPanelist(BaseModel):
    ...
    lightning_round_start: Union[int, None] = Field(default=None,
                                                    title="Lightning Fill-in-the-Blank Starting Score")
    lightning_round_correct: Union[int, None] = Field(default=None,
                                                      title="Lightning Fill-in-the-Blank Corect Answers")
    score: Union[int, None] = Field(default=None,
                                    title="Panelist Score")
    rank: Union[str, None] = Field(default=None,
                                   title="Panelist Rank")
...
class ShowGuest(BaseModel):
    ...
    score: Union[int, None] = Field(default=None,
                                    title="Guest Score")
    score_exception: bool = Field(default=False,
